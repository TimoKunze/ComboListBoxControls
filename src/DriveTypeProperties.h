//////////////////////////////////////////////////////////////////////
/// \class DriveTypeProperties
/// \author Timo "TimoSoft" Kunze
/// \brief <em>The control's "Drive Types" property page</em>
///
/// This class contains the control's "Drive Types" property page.
///
/// \sa DriveComboBox
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE DriveTypeProperties :
    public CComObjectRootEx<CComSingleThreadModel>,
    public CComCoClass<DriveTypeProperties, &CLSID_DriveTypeProperties>,
    public IPropertyPageImpl<DriveTypeProperties>,
    public CDialogImpl<DriveTypeProperties>
{
public:
	...
	DriveTypeProperties();
		...
		enum { IDD = IDD_DRIVETYPEPROPERTIES };

		DECLARE_REGISTRY_RESOURCEID(IDR_DRIVETYPEPROPERTIES)

		BEGIN_COM_MAP(DriveTypeProperties)
			COM_INTERFACE_ENTRY(IPropertyPage)
		END_COM_MAP()

		BEGIN_MSG_MAP(DriveTypeProperties)
...
protected:
	...
	struct Controls
	{
		/// \brief <em>Wraps the list view displaying the values for the \c DisplayedDriveTypes property</em>
		CCheckListViewCtrl displayedDriveTypesList;
		/// \brief <em>Wraps the list view displaying the values for the \c DriveTypesWithVolumeName property</em>
		CCheckListViewCtrl driveTypesWithVolumeNamesList;
...
OBJECT_ENTRY_AUTO(CLSID_DriveTypeProperties, DriveTypeProperties)