...
///
/// \if UNICODE
///   \sa CBLCtlsLibU::IOLEDataObject, TargetOLEDataObject, ImageComboBox, ListBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa CBLCtlsLibA::IOLEDataObject, TargetOLEDataObject, ImageComboBox, ListBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, ImageComboBox::get_SupportOLEDragImages, ListBox::get_SupportOLEDragImages,
	///       CBLCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, ImageComboBox::get_SupportOLEDragImages, ListBox::get_SupportOLEDragImages,
	///       CBLCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///            Windows&reg; SDK are valid.
	///
	/// \sa GetData, Clear, ImageComboBox::Raise_OLESetData, ListBox::Raise_OLESetData,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms649049.aspx">RegisterClipboardFormat</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms682177.aspx">FORMATETC</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/bb776902.aspx#CFSTR_FILECONTENTS">CFSTR_FILECONTENTS</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms690318.aspx">DVASPECT</a>
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, ImageComboBox::put_SupportOLEDragImages, ListBox::put_SupportOLEDragImages,
	///       CBLCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, ImageComboBox::put_SupportOLEDragImages, ListBox::put_SupportOLEDragImages,
...
protected:
	...
	struct Properties
	{
		/// \brief <em>The \c DriveComboBox object that owns this object</em>
		///
		/// \sa SetOwner
		DriveComboBox* pOwnerDCBox;
		/// \brief <em>The \c ImageComboBox object that owns this object</em>
		///
		/// \sa SetOwner
		ImageComboBox* pOwnerICBox;
		/// \brief <em>The \c ListBox object that owns this object</em>
		///
		/// \sa SetOwner
		ListBox* pOwnerLBox;
