...
///
/// This class provides easy access (including filtering) to collections of \c ComboBoxItem
/// objects. A \c ComboBoxItems object is used to group items that have certain properties in
/// common.
///
/// \if UNICODE
///   \sa CBLCtlsLibU::IComboBoxItems, ComboBoxItem, ComboBox
/// \else
///   \sa CBLCtlsLibA::IComboBoxItems, ComboBoxItem, ComboBox
/// \endif
//////////////////////////////////////////////////////////////////////
...
#include "res/resource.h"
	...
	#include "CBLCtlsA.h"
#endif
#include "_IComboBoxItemsEvents_CP.h"
#include "helpers.h"
...
class ATL_NO_VTABLE ComboBoxItems : 
    public CComObjectRootEx<CComSingleThreadModel>,
    public CComCoClass<ComboBoxItems, &CLSID_ComboBoxItems>,
    public ISupportErrorInfo,
    public IConnectionPointContainerImpl<ComboBoxItems>,
    public Proxy_IComboBoxItemsEvents<ComboBoxItems>,
    public IEnumVARIANT,
    #ifdef UNICODE
    	public IDispatchImpl<IComboBoxItems, &IID_IComboBoxItems, &LIBID_CBLCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IComboBoxItems, &IID_IComboBoxItems, &LIBID_CBLCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
...
public:
		...
		DECLARE_REGISTRY_RESOURCEID(IDR_COMBOBOXITEMS)

		BEGIN_COM_MAP(ComboBoxItems)
			COM_INTERFACE_ENTRY(IComboBoxItems)
		...
		BEGIN_CONNECTION_POINT_MAP(ComboBoxItems)
			CONNECTION_POINT_ENTRY(__uuidof(_IComboBoxItemsEvents))
	...
	//////////////////////////////////////////////////////////////////////
	/// \name Implementation of IComboBoxItems
	///
	//@{
	...
	///
	/// Retrieves a \c ComboBoxItem object from the collection that wraps the combo box item identified
	/// by \c itemIdentifier.
	///
	...
	/// \param[out] ppItem Receives the item's \c IComboBoxItem implementation.
	///
	/// \return An \c HRESULT error code.
	///
	...
	/// \endif
	virtual HRESULT STDMETHODCALLTYPE get_Item(LONG itemIdentifier, ItemIdentifierTypeConstants itemIdentifierType = iitIndex, IComboBoxItem** ppItem = NULL);
	/// \brief <em>Retrieves a \c VARIANT enumerator</em>
	///
	/// Retrieves a \c VARIANT enumerator that may be used to iterate the \c ComboBoxItem objects
	...
	/// \c ComboBoxItem object wrapping the inserted item.
	///
	...
	/// \param[out] ppAddedItem Receives the added item's \c IComboBoxItem implementation.
	///
	/// \return An \c HRESULT error code.
	///
	...
	///
	/// \sa Count, Remove, RemoveAll, ComboBoxItem::get_Text, ComboBoxItem::get_ItemData,
	///     ComboBox::get_HasStrings, ComboBox::get_OwnerDrawItems, ComboBox::PrepareForItemInsertions
	virtual HRESULT STDMETHODCALLTYPE Add(BSTR itemText, LONG insertAt = -1, LONG itemData = 0, IComboBoxItem** ppAddedItem = NULL);
...
protected:
	...
	/// \param[in] hWndCBox The combo box window the method will work on.
	///
	...
	int GetFirstItemToProcess(int numberOfItems, HWND /*hWndCBox*/);
	...
	int GetNextItemToProcess(int previousItem, int numberOfItems, HWND /*hWndCBox*/);
	...
	BOOL IsPartOfCollection(int itemIndex, HWND hWndCBox = NULL);
	//@}
	//////////////////////////////////////////////////////////////////////
	...
	void OptimizeFilter(FilteredPropertyConstants filteredProperty);
		...
		///
		/// \return An \c HRESULT error code.
		HRESULT RemoveItems(std::list<int>& itemsToRemove, HWND hWndCBox);
	#else
		/// \brief <em>Removes the specified items</em>
		///
		/// \param[in] itemsToRemove A vector containing all items to remove.
		...
		///
		/// \return An \c HRESULT error code.
		HRESULT RemoveItems(CAtlList<int>& itemsToRemove, HWND hWndCBox);
	#endif
	...
	struct Properties
	{
		...
		/// \brief <em>The \c ComboBox object that owns this collection</em>
		///
		/// \sa SetOwner
		ComboBox* pOwnerCBox;
		...
		///
		/// \return The window handle of the combo box that contains the items in this collection.
		///
		/// \sa pOwnerCBox
...
OBJECT_ENTRY_AUTO(__uuidof(ComboBoxItems), ComboBoxItems)