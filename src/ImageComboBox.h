...
protected:
	...
	struct DragDropStatus
	{
		...
		/// \param[in] pDraggedItms The \c IImageComboBoxItemContainer implementation of the collection of
		///            the dragged items.
		...
		///
		/// \sa EndDrag
		HRESULT BeginDrag(HWND hWndComboBoxEx, IImageComboBoxItemContainer* pDraggedItms, HIMAGELIST hDragImgList, PINT pXHotSpot, PINT pYHotSpot)
		{
