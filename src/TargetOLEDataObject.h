...
///
/// \if UNICODE
///   \sa CBLCtlsLibU::IOLEDataObject, ComboBox, DriveComboBox, ImageComboBox, ListBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa CBLCtlsLibA::IOLEDataObject, ComboBox, DriveComboBox, ImageComboBox, ListBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE TargetOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_CBLCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_CBLCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, ComboBox::get_SupportOLEDragImages,
	///       DriveComboBox::get_SupportOLEDragImages, ImageComboBox::get_SupportOLEDragImages,
	///       ListBox::get_SupportOLEDragImages, CBLCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, ComboBox::get_SupportOLEDragImages,
	///       DriveComboBox::get_SupportOLEDragImages, ImageComboBox::get_SupportOLEDragImages,
	///       ListBox::get_SupportOLEDragImages, CBLCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, ComboBox::put_SupportOLEDragImages,
	///       DriveComboBox::put_SupportOLEDragImages, ImageComboBox::put_SupportOLEDragImages,
	///       ListBox::put_SupportOLEDragImages, CBLCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, ComboBox::put_SupportOLEDragImages,
	///       DriveComboBox::put_SupportOLEDragImages, ImageComboBox::put_SupportOLEDragImages,
	///       ListBox::put_SupportOLEDragImages, CBLCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
